...
ALTER TABLE [dbo].[Payment_cred] ADD  CONSTRAINT [DF_Payment_cred_Credit_Card_No.]  DEFAULT ((0)) FOR [Balance]
GO
...
ALTER TABLE [dbo].[Payment_cred] CHECK CONSTRAINT [FK_Payment_cred_Payment_cred]
GO
