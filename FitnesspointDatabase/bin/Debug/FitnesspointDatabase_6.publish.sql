...
GO
PRINT N'Creating Table [dbo].[PaymentTbl]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_PaymentTbl_NutritionPlan]...';


GO
ALTER TABLE [dbo].[PaymentTbl]
    ADD CONSTRAINT [FK_PaymentTbl_NutritionPlan] FOREIGN KEY ([Plan_id]) REFERENCES [dbo].[NutritionPlan] ([NutriPlanId]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_PaymentTbl_UserDetails]...';
